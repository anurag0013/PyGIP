...
class GraphGenerator(nn.Module):
    """Generator model for creating synthetic graph data.
    
    This generator can create both node features and graph structure
    using either cosine similarity or full parameterization approaches.
    """
    ...
    def __init__(self, noise_dim, num_nodes, feature_dim, generator_type='cosine', threshold=0.1):
        ...
        Args:
            ...
            generator_type: Type of graph structure generation ('cosine' or 'full_param')

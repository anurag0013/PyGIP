...
class SurrogateModel(nn.Module):
    """Surrogate model used to imitate the victim model's behavior.
    
    This model is trained using the synthetic data generated by the
    GraphGenerator and predictions from the victim model.
    """

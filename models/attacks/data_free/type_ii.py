...
class TypeIIAttack(DataFreeBaseAttack):
    """Type II data-free attack implementation.
    
    This attack uses direct gradient information from the surrogate model
    to guide the generator in creating synthetic graph data that helps
    better extract knowledge from the victim model.
    ...
    def train_generator(self):
        """Train the generator model using direct gradient information.
        ...
        for _ in range(self.n_generator_steps):
            ...
            # Type II uses direct gradient from surrogate model
    ...
    def train_surrogate(self):
        """Train the surrogate model to mimic victim model behavior.
